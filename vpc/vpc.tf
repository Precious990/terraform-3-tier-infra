...
resource "aws_route_table" "publc_route_table" {
  vpc_id = aws_vpc.main.id
...
resource "aws_route_table_association" "public_subnet1_association" {
  ...
  route_table_id = aws_route_table.publc_route_table.id
}
...
resource "aws_nat_gateway" "nat_gw" {
  ...
  tags = merge(var.tags, {
      Name = "${var.tags["project"]}-${var.tags["application"]}-${var.tags["environment"]}-nat-gt"
  })
